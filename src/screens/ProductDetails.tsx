...
import { Button, Pill, Thumb } from '../components/ui'
...
export default function ProductDetails() {
  ...
  const tiles = [
    ...
    { label: 'Selling Price', value: `₹${product.sellingPrice}`, Icon: TagIcon, tone: 'brand' as const },
    { label: 'Purchase Price', value: `₹${product.purchasePrice}`, Icon: CartIcon, tone: 'brand' as const },
